...
$('body').on('submit', '#frmSize', function (event) {
    event.preventDefault();
...
$('body').on('submit', '#frmSizeDelete', function (event) {
    event.preventDefault();
    let method = $('input[name="_method"]').val();
    if (method === "DELETE") {
        formDestroy();
...
function create() {
    return $.ajax({
        ...
        url: `${URL_BASE}/empresa/sizes/create`,
        method: "GET",
        dataType: "json"
    });
}
...
function edit(id) {
    return $.ajax({
        ...
        url: `${URL_BASE}/empresa/sizes/${id}/edit`,
        method: "GET",
        dataType: "json"
    });
}
...
function _delete(id) {
    return $.ajax({
        ...
        url: `${URL_BASE}/empresa/sizes/${id}/delete`,
        method: "GET",
        dataType: "json"
    });
}
...
function store() {
    let form = $('#frmSize').serialize();
    return $.ajax({
        headers: {
            'X-CSRF-TOKEN': CSRF
        },
        url: URL_BASE + "/empresa/sizes",
        method: "POST",
        dataType: "json",
        data: form
    });
...
function destroy(id) {
    let form = $('#frmSizeDelete').serialize();
    return $.ajax({
        headers: {
            'X-CSRF-TOKEN': CSRF
        },
        url: `${URL_BASE}/empresa/sizes/${id}/destroy`,
        method: "delete",
        dataType: "json",
        data: form
    });
