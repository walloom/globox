    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8 p-0">
                <a href="#" data-click="create" class="btn btn-app {{ Permission::disabled('empresa/units/create') }}">
...
@push('js')
<script type="text/javascript" src="{{ asset('js/pages/units/index.js') }}"></script>
@endpush
